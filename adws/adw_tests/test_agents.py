...
def run_test_model(model: str, adw_id: str) -> tuple[bool, str]:
...
def run_test_retry_functionality(adw_id: str) -> tuple[bool, str]:
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=len(MODELS)) as executor:
        ...
        future_to_model = {
            executor.submit(run_test_model, model, adw_id): model for model in MODELS
        }
    ...
    retry_success, retry_message = run_test_retry_functionality(adw_id)
