...
def analyze_task_description(
    ...
    This function uses the /clarify slash command which is executed via Claude Code CLI,
    utilizing the user's Claude Max subscription instead of direct API calls.
    ...
    # Build args for the /clarify command
    # The command takes task_description as $1 and optional feedback as $2
